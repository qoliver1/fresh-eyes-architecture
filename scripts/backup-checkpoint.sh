...
echo "============================================"
echo ""
echo "  Framework:  $FRAMEWORK_MSG"
echo "  Source:     $SOURCE_MSG"
echo ""
echo "  Baseline tag:  fresh-install-baseline (git diff my-changes..fresh-install-baseline)"
echo "  To revert:     cd ~/hermes-agent && git reset --hard fresh-install-baseline"
echo ""
